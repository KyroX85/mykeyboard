...
class ExecutionLayerShellGuardrailsTest {
    ...
    fun executionLayerShellIsHandleActivatedWithoutFeatureBackend() {
        ...
        assertTrue(source.contains("Just speak naturally."))
    ...
    fun executionLayerIsVoiceFirstNotDashboardFirst() {
        ...
        assertTrue(source.contains("scheduleExecutionAutoListen()"))
        assertTrue(source.contains("startExecutionMicPulse()"))
        assertTrue(source.contains("Understanding your request..."))
        assertTrue(source.contains("Opening ${'$'}{target.label}..."))
        ...
        assertFalse(setup.contains("Cancel"))
        assertFalse(overlay.contains("Cancel"))
    ...
    fun founderExecutionLayerLaunchesAppsOnlyThroughLocalVoiceIntent() {
        ...
        assertFalse(resolution.contains("packageManager.queryIntentActivities"))
        assertTrue(source.contains("refreshLaunchableAppCache"))
        assertTrue(source.contains("buildLaunchableAppCache"))
        assertTrue(source.contains("packageManager.queryIntentActivities"))
