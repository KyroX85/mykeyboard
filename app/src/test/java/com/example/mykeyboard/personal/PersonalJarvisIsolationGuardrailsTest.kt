...
class PersonalJarvisIsolationGuardrailsTest {
    ...
    fun wakeWordServiceDelegatesOneCommandToFounderBrainVoiceSummary() {
        ...
        assertTrue(wakeService.contains("Jarvis command captured: \${debugTranscriptLabel(question)}"))
        assertTrue(wakeService.contains("Jarvis command recognition alternatives: count="))
        assertTrue(wakeService.contains("debugTranscriptLabel"))
        assertTrue(wakeService.contains("debugAlternativesLabel"))
        assertTrue(wakeService.contains("BuildConfig.DEBUG"))
