...
class PersonalJarvisIsolationGuardrailsTest {
    ...
    fun wakeWordServiceKeepsActiveConversationAfterFounderBrainVoiceSummary() {
        ...
        assertTrue(wakeService.contains("JarvisConversationState.WAITING_FOR_FOLLOWUP"))
        ...
        assertTrue(wakeDetection.contains("speaker?.speak(JarvisConversationModePolicy.WAKE_ACKNOWLEDGEMENT, afterAcknowledgement)"))
        ...
        assertTrue(wakeService.contains("speakAndContinueConversation(speech"))
        assertTrue(wakeService.contains("transitionTo(JarvisConversationState.WAITING_FOR_FOLLOWUP, \"conversation speech complete\")"))
        assertTrue(wakeService.contains("transitionTo(JarvisConversationState.COMMAND_CAPTURE, \"follow-up listening started\")"))
