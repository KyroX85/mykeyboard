...
class PersonalJarvisIsolationGuardrailsTest {
    ...
    fun wakeWordServiceDelegatesOneCommandToFounderBrainVoiceSummary() {
        ...
        assertTrue(wakeDetection.contains("speaker?.speak(JarvisWakeResponseGate.RESPONSE_TEXT, startCommandListening)"))
        ...
        assertTrue(wakeService.contains("handleCommandText(latestCommandPartial)"))
        ...
        assertTrue(wakeService.contains("RecognizerIntent.EXTRA_PARTIAL_RESULTS, true"))
        assertTrue(wakeService.contains("RecognizerIntent.EXTRA_SPEECH_INPUT_MINIMUM_LENGTH_MILLIS"))
        assertTrue(wakeService.contains("selectBestCommandTranscript"))
